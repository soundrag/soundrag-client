...
const LISTENER_STARTING_ROTATION = [0, -Math.PI / 2, 0];
...
const FIRST_SPEAKER_STARTING_POSITION = [-2, -0.05, -5];
const SECOND_SPEAKER_STARTING_POSITION = [-2, -0.05, 5];
const LISTENER_STARTING_POSITION = [5, -0.05, 0];
